...
" Compile
"map <C-o> :!open -a TeXShop %<CR>  
map <C-o> \lv <CR>  
"map <F2> :!open -a TeXShop %<CR>  
"map <F3> :w<CR> :!pdflatex %<CR>  
"map <C-t> :w <cr> \ll
map <C-t> :w <cr> :!/usr/texbin/pdflatex --shell-escape --synctex=1 %<CR>

"imap <C-o> <Esc> :!open -a TeXShop %<CR> 
imap <C-o> <Esc> \lv <CR> 
"imap <F2> <Esc> :!open -a TeXShop %<CR> 
"imap <F3> <Esc>:w<CR> :!pdflatex %<CR>  
"imap <C-t> <esc> :w <cr> \ll

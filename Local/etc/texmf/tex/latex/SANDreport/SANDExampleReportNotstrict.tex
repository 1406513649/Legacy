...
been overcome, dry erase markers find many uses in todays science
and engineering. In this report we explain some of the
fundamental properties, dangers, and benefits of dry erase markers. We
...
\label{Intro}
In~\cite{Potter} we have shown that dry erase markers have a use in science. In
this report we address the use of dry erase markers specifically to the science
and engineering performed at the DOE national laboratories. Let us begin with a
description of a couple of basic dry erase marker drawings. We use the circle and
the square to make our point.

\section{The Circle}
Figure~\ref{fig1} shows one of the basic shapes. It appears in many dry erase
drawings and has many important properties.
...
sure titles and table of content entries work for those.
	...
	\begin{figure}[ht]
		...
		\includegraphics[keepaspectratio=true, width=2.0in]{hippogriff.eps}
	    }
	    \subfigure[A Dragon]{
		\label{fig:sub:intro:creatures:dragon}
		\includegraphics[keepaspectratio=true, width=2.0in]{dragon.eps}
	    }

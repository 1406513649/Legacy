...
import src.fem.core.utilities as utils
import src.fem.core.fe_model as fem
from src.base.errors import WasatchError
from src.fem.core.boundary import apply_dirichlet_bcs
from src.fem.core.utilities import update_element_states, intro
from src.fem.core.glob_stiff import global_stiffness
from src.fem.core.glob_trxn import global_traction
from src.fem.core.glob_resid import global_residual
...
class Lento(fem.FEModel):
    ...
    def solve(self, nproc=1, disp=0):
        ...
        self.logger.write(intro("Implicit", runid, nsteps, tol,

...
import src.fem.io.io as io
import src.base.utilities as utils
from src.base.errors import WasatchError
from src.base.consts import HUGE
from src.fem.io.logger import Logger
from src.fem.solve.boundary import apply_dirichlet_bcs
from src.fem.solve.utilities import update_element_states, intro
from src.fem.solve.glob_stiff import global_stiffness
from src.fem.solve.glob_trxn import global_traction
from src.fem.solve.glob_mass import global_mass
...
def fe_solve(exo_io, runid, control, X, connect, elements, fixnodes,
    ...
    logger.write(intro("Explicit", runid, nsteps, tol, maxit, relax, tstart,
    ...
    for step in range(nsteps):
        ...
        if ro.verbosity > 2:
            io.write_results(logger, t, X, connect, elements,
